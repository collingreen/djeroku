...
MIDDLEWARE_CLASSES = (
    ...
    # Disabled to protect against BREACH http://breachattack.com
...
# many inspirations from https://github.com/10clouds/heroku-django-pipeline/blob/master/heroku_template/settings.py
PIPELINE = not DEBUG
...
# images in embed folders under the max embed size will be embedded in the css
